...
class ForceDelete extends Component
{
    ...
    protected $listeners = ['force_delete_employee'];
    public function force_delete_employee($id)
    {
        ...
        $this->resetErrorBag();
            ...
            // Open modal
        $this->dispatch('force-delete-employee-modal');
    }
    ...
    public function submit()
    {
        ...
        $this->service->forceDelete($this->model);
    ...
    {
        return view('employees::livewire.employees.partials.force-delete');
