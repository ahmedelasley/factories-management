                ...
                <div class=" tab-menu-heading">
                    <div class="tabs-menu1">
                        ...
                        <ul class="nav panel-tabs main-nav-line">
                            <li class="nav-item"><a href="#active" class="nav-link {{ $trashed == false ? 'active' : ''}}" data-toggle="tab" wire:click="selectTab(false)">{{ __('Active Employees') }}</a></li>
                            <li class="nav-item"><a href="#archive" class="nav-link {{ $trashed == true ? 'active' : ''}}" data-toggle="tab" wire:click="selectTab(true)">{{ __('Archive Employees') }}</a></li>
                        </ul>
                    </div>
                </div>
                <div class="panel-body tabs-menu-body main-content-body-right border-top-0 border">
                    <div class="tab-content">
                        <div class="tab-pane {{ $trashed == false ? 'active' : ''}}" id="active">
                                ...
                                <table id="" class="table table-striped table-bordered table-hover text-md-wrap text-center" >
                                    {{-- <thead> --}}
                                        <tr class="bg-dark fs-14 text-bold text-white  text-center">
                                            ...
                                            <th class="w-20"><a class="d-flex justify-content-between link-no-color" type="button" href="javascript:void(0);" wire:click="sortBy('hire_date')" wire:key="Hire Date">{{ __('Hire Date')}} <i class="fas fa-sort"></i></a></th>
                                                ...
                                                <td class="text-center">
                                                    <div class="dropdown">
                                                        ...
                                                        <ul class="dropdown-menu table-bordered table-striped table-hover text-md-wrap fs-18">
                                                            ...
                                                            <li><a class="dropdown-item" href="javascript:void(0);"  wire:click.prevent="$dispatch('delete_employee', { id: {{ $value->id }} })"> <b class="text-dark"><i class="bx bx-archive"></i> {{ __('Archive') }}</b></a></li>
                        ...
                        <div class="tab-pane {{ $trashed == true ? 'active' : ''}}" id="archive">
                            <div class="table-responsive hoverable-table">
                                <table id="" class="table table-striped table-bordered table-hover text-md-wrap text-center" >
                                    {{-- <thead> --}}
                                        <tr class="bg-dark fs-14 text-bold text-white  text-center">
