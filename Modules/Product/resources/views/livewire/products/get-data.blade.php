                ...
                <table id="" class="table table-striped table-bordered table-hover text-md-wrap text-center" >
                    {{-- <thead> --}}
                        <tr class="bg-dark fs-14 text-bold text-white  text-center">
                            ...
                            <th class="w-20"><a class="d-flex justify-content-between link-no-color" type="button" href="javascript:void(0);" wire:click="sortBy('description')" wire:key="value">{{ __('Description')}} <i class="fas fa-sort"></i></a></th>
                            <th class="w-20"><a class="d-flex justify-content-between link-no-color" type="button" href="javascript:void(0);" wire:click="sortBy('storage_unit')" wire:key="value">{{ __('Storage Unit')}} <i class="fas fa-sort"></i></a></th>
                            <th class="w-30"><a class="d-flex justify-content-between link-no-color" type="button" href="javascript:void(0);" wire:click="sortBy('ingredient_unit')" wire:key="attribute">{{ __('Ingredient Unit')}} <i class="fas fa-sort"></i></a></th>
                            <th class="w-30"><a class="d-flex justify-content-between link-no-color" type="button" href="javascript:void(0);" wire:click="sortBy('conversion_factor')" wire:key="attribute">{{ __('Conversion Factor')}} <i class="fas fa-sort"></i></a></th>
                    ...
                    <tbody>
                        @foreach($data as $value)
                            <tr class="fs-18 fw-bold">
                                ...
                                <th><b>{{ $value->description }}</b></th>
                                <th><b>{{ $value->storage_unit }}</b></th>
                                <th><b>{{ $value->ingredient_unit }}</b></th>
                                <th><b>{{ $value->conversion_factor }}</b></th>
                                <td>
