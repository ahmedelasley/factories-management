            ...
            <div class="d-flex justify-content-start m-3">
                ...
                <div style="margin-inline-start: 10px">
                    ...
                    <ul class="dropdown-menu table-bordered table-striped table-hover text-md-wrap">
                        ...
                        <li><a class="dropdown-item {{ $searchField == 'supplier' ? 'active' : ''}}" href="javascript:void(0);" wire:click="searchFilter('supplier')"><b>{{ __('Supplier')}}</b></a></li>
                ...
                <table id="" class="table table-striped table-bordered table-hover text-md-wrap text-center" >
                    {{-- <thead> --}}
                        <tr class="bg-dark fs-14 text-bold text-white  text-center">
                            ...
                            <th class="w-20"><a class="d-flex justify-content-between link-no-color" type="button" href="javascript:void(0);" wire:click="sortBy('email')" wire:key="email">{{ __('Email')}} <i class="fas fa-sort"></i></a></th>
                            <th class="w-20"><a class="d-flex justify-content-between link-no-color" type="button" href="javascript:void(0);" wire:click="sortBy('phone')" wire:key="phone">{{ __('Phone')}} <i class="fas fa-sort"></i></a></th>
                            <th class="w-20"><a class="d-flex justify-content-between link-no-color" type="button" href="javascript:void(0);" wire:click="sortBy('address')" wire:key="address">{{ __('Address')}} <i class="fas fa-sort"></i></a></th>
                            ...
                            <th class="w-10"><a class="d-flex justify-content-between link-no-color" type="button" href="javascript:void(0);" wire:click="sortBy('supplier')" wire:key="supplier">{{ __('Supplier')}} <i class="fas fa-sort"></i></a></th>
                    ...
                    <tbody>
                        @foreach($data as $value)
                            <tr class="fs-18 fw-bold">
                                ...
                                <td><b><span class="badge badge-primary">{{ $value->supplier?->name }}</span></b></td>
                                <td>
                                ...
                                <td class="text-center">
                                    <div class="dropdown">
                                        ...
                                        <ul class="dropdown-menu table-bordered table-striped table-hover text-md-wrap fs-18">
                                            <li><a class="dropdown-item" href="javascript:void(0);" wire:click.prevent="$dispatch('show_company', { id: {{ $value->id }} })"> <b><i class="bx bx-info-circle"></i> {{ __('Details') }}</b></a></li>
                                            <li><a class="dropdown-item" href="javascript:void(0);" wire:click.prevent="$dispatch('edit_company', { id: {{ $value->id }} })"> <b><i class="bx bx-edit"></i> {{ __('Edit', ['type' => __('Company')]) }}</b></a></li>
                                            <li><a class="dropdown-item" href="javascript:void(0);" wire:click.prevent="$dispatch('toggle_status_company', { id: {{ $value->id }} })"> <b><i class="{{ $value->status->swapIcon() }}"></i> {{ $value->status->swapBtnLabel() }}</b></a></li>
                                            <div class="dropdown-divider"></div>
                                            <li><a class="dropdown-item" href="javascript:void(0);"  wire:click.prevent="$dispatch('delete_company', { id: {{ $value->id }} })"> <b class="text-danger"><i class="bx bx-trash"></i> {{ __('Delete', ['type' => __('Company')]) }}</b></a></li>
                                        </ul>
                                    </div>
                                </td>
                                </b>
