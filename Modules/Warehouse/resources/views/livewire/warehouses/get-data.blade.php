            ...
            <div class="d-flex justify-content-start m-3">
                ...
                <div style="margin-inline-start: 10px">
                    ...
                    <ul class="dropdown-menu table-bordered table-striped table-hover text-md-wrap">
                        ...
                        <li><a class="dropdown-item {{ $searchField == 'code' ? 'active' : ''}}" href="javascript:void(0);" wire:click="searchFilter('code')"><b>{{ __('Code')}}</b></a></li>
                        <li><a class="dropdown-item {{ $searchField == 'name' ? 'active' : ''}}" href="javascript:void(0);" wire:click="searchFilter('name')"><b>{{ __('Name')}}</b></a></li>
                        <li><a class="dropdown-item {{ $searchField == 'location' ? 'active' : ''}}" href="javascript:void(0);" wire:click="searchFilter('location')"><b>{{ __('Location')}}</b></a></li>
                        <li><a class="dropdown-item {{ $searchField == 'capacity' ? 'active' : ''}}" href="javascript:void(0);" wire:click="searchFilter('capacity')"><b>{{ __('Capacity')}}</b></a></li>
                        <li><a class="dropdown-item {{ $searchField == 'type' ? 'active' : ''}}" href="javascript:void(0);" wire:click="searchFilter('type')"><b>{{ __('Type')}}</b></a></li>
                ...
                <table id="" class="table table-striped table-bordered table-hover text-md-wrap text-center" >
                    {{-- <thead> --}}
                        <tr class="bg-dark fs-14 text-bold text-white  text-center">
                            ...
                            <th class="w-20"><a class="d-flex justify-content-between link-no-color" type="button" href="javascript:void(0);" wire:click="sortBy('code')" wire:key="value">{{ __('Code')}} <i class="fas fa-sort"></i></a></th>
                            ...
                            <th class="w-20"><a class="d-flex justify-content-between link-no-color" type="button" href="javascript:void(0);" wire:click="sortBy('location')" wire:key="value">{{ __('Location')}} <i class="fas fa-sort"></i></a></th>
                            <th class="w-20"><a class="d-flex justify-content-between link-no-color" type="button" href="javascript:void(0);" wire:click="sortBy('capacity')" wire:key="value">{{ __('Capacity')}} <i class="fas fa-sort"></i></a></th>
                            <th class="w-30"><a class="d-flex justify-content-between link-no-color" type="button" href="javascript:void(0);" wire:click="sortBy('type')" wire:key="attribute">{{ __('Type')}} <i class="fas fa-sort"></i></a></th>
                    ...
                    <tbody>
                        @foreach($data as $value)
                            <tr class="fs-18 fw-bold">
                                ...
                                <th><b>{{ $value->code }}</b></th>
                                <th><b>{{ $value->name }}</b></th>
                                <th><b>{{ $value->location }}</b></th>
                                <th><b>{{ $value->capacity }}</b></th>
                                <td>
                                    <h6 class=""> <div class="dot-label  ml-1" ></div><b>{{ $value->type?->label() }}</b></h6>
                                </td>
                                <td>
                                ...
                                <td class="text-center">
                                    <div class="dropdown">
                                        ...
                                        <ul class="dropdown-menu table-bordered table-striped table-hover text-md-wrap fs-18">
                                            <li><a class="dropdown-item" href="javascript:void(0);" wire:click.prevent="$dispatch('show_warehouse', { id: {{ $value->id }} })"> <b><i class="bx bx-info-circle"></i> {{ __('Details') }}</b></a></li>
                                            <li><a class="dropdown-item" href="javascript:void(0);" wire:click.prevent="$dispatch('edit_warehouse', { id: {{ $value->id }} })"> <b><i class="bx bx-edit"></i> {{ __('Edit', ['type' => __('value')]) }}</b></a></li>
                                            <li><a class="dropdown-item" href="javascript:void(0);" wire:click.prevent="$dispatch('toggle_status_warehouse', { id: {{ $value->id }} })"> <b><i class="{{ $value->status->swapIcon() }}"></i> {{ $value->status->swapBtnLabel() }}</b></a></li>
                                            <div class="dropdown-divider"></div>
                                            <li><a class="dropdown-item" href="javascript:void(0);"  wire:click.prevent="$dispatch('delete_warehouse', { id: {{ $value->id }} })"> <b class="text-danger"><i class="bx bx-trash"></i> {{ __('Delete', ['type' => __('Warehouse')]) }}</b></a></li>
                                        </ul>
                                    </div>
                                </td>
                                </b>
