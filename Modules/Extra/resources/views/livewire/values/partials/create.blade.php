    ...
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content modal-content-demo">
            <div class="modal-header">
                <h6 class="modal-title">{{ __('Add', ['type' => __('Value')] ) }}</h6>
            ...
            <div class="modal-body">
                <form id="form">
                    ...
                    <div class="form-group">
                        <label class="main-content-label tx-12 tx-medium">{{ __('Value') }}</label>
                        <input class="form-control" type="text" name="name" wire:model.blur='value' autofocus >
